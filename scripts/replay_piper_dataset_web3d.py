...
class DatasetWeb3DApp:
    ...
    def load_parquet(self, parquet_file: Path, episode_index: int | None) -> dict[str, Any]:
        with self.lock:
            ...
            self.gripper = (
                load_gripper_values(parquet_file, self.gripper_column, len(self.deltas))
...
<body>
  <div class="shell">
    <main><iframe src="{escaped_meshcat}" title="MeshCat replay"></iframe></main>
    <aside>
